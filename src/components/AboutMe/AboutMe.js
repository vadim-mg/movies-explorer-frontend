  ...
  return (
    <div className="about-me">
      ...
      <p className="about-me__text">
        Я родился в СССР, закончил ТюмГНГУ в 2003г, работаю с тех пор в сфере ИТ на разных должностях. У меня есть жена и дети. Я люблю природу, туризм и технику. В декабре решил пройти курс по веб-разработке. Работы выполненные в процессе обучения оформил в виде портфолио, которое ниже.
      </p>
